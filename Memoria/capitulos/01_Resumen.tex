...
Este proyecto busca permitir al usuario visualizar las imágenes resultantes de una consulta a un sistema de recuperación de información de una manera atractiva, interactiva y amigable. En esta ocasión dicho sistema ha sido desarrollado para plataformas móviles, concretamente \textit{Android}.\\
